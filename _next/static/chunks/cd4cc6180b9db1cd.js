(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    class n extends Error {
      constructor(e, a = {}) {
        const o =
            a.cause instanceof n
              ? a.cause.details
              : a.cause?.message
              ? a.cause.message
              : a.details,
          s = (a.cause instanceof n && a.cause.docsPath) || a.docsPath,
          i = r.getDocsUrl?.({ ...a, docsPath: s });
        super(
          [
            e || "An error occurred.",
            "",
  ...
  (e) => {
    "use strict";
    var t = e.i(103140);
    function r(e, { dir: a, size: o = 32 } = {}) {
      return "string" == typeof e
        ? n(e, { dir: a, size: o })
        : (function (e, { dir: r, size: n = 32 } = {}) {
            if (null === n) return e;
            if (e.length > n)
  ...
  (e) => {
    "use strict";
    e.s(
      ["hexToBytes", () => x, "stringToBytes", () => $, "toBytes", () => w],
      657430
    );
    var t = e.i(768288),
      r = e.i(875087),
    ...
    function i(e, { size: t }) {
      if ((0, o.size)(e) > t)
        throw new a.SizeOverflowError({
          givenSize: (0, o.size)(e),
          maxSize: t,
        });
    }
    function c(e, t = {}) {
    ...
    function u(e, t = {}) {
      let r = e;
      if ((t.size && (i(r, { size: t.size }), (r = s(r))), "0x00" === s(r)))
        return !1;
      if ("0x01" === s(r)) return !0;
      throw new a.InvalidHexBooleanError(r);
    }
    function d(e, t = {}) {
      return Number(c(e, t));
    }
    function l(e, t = {}) {
      let r = x(e);
      return (
        t.size && (i(r, { size: t.size }), (r = s(r, { dir: "right" }))),
    ...
    function p(e, t = {}) {
      ...
      return "number" == typeof t.size
        ? (i(r, { size: t.size }), (0, n.pad)(r, { size: t.size }))
        : r;
    }
    function h(e, t = {}) {
      let r = "";
      ...
      return "number" == typeof t.size
        ? (i(a, { size: t.size }),
          (0, n.pad)(a, { dir: "right", size: t.size }))
        : a;
    }
    function m(e, t = {}) {
      let r,
      ...
      let c = "bigint" == typeof r && o ? -r - 1n : 0;
      if ((r && i > r) || i < c) {
      ...
      let u = `0x${(o && i < 0
        ? (1n << BigInt(8 * s)) + BigInt(i)
        : i
      ).toString(16)}`;
      return s ? (0, n.pad)(u, { size: s }) : u;
    }
    let y = new TextEncoder();
    function g(e, t = {}) {
      return h(y.encode(e), t);
    }
    ...
    function x(e, r = {}) {
      ...
      r.size &&
        (i(a, { size: r.size }),
        (a = (0, n.pad)(a, { dir: "right", size: r.size })));
      let o = a.slice(2);
      o.length % 2 && (o = `0${o}`);
      let s = o.length / 2,
        c = new Uint8Array(s);
      for (let e = 0, r = 0; e < s; e++) {
        let n = E(o.charCodeAt(r++)),
          a = E(o.charCodeAt(r++));
    ...
    var A = e.i(145535);
    function P(e, t) {
      let n = (0, A.keccak_256)((0, r.isHex)(e, { strict: !1 }) ? w(e) : e);
      return "bytes" === (t || "hex") ? n : b(n);
    }
    e.s(["keccak256", () => P], 195746);
  },
  893029,
  798315,
  253082,
  (e) => {
    "use strict";
    e.s(["checksumAddress", () => u, "getAddress", () => d], 893029);
    var t = e.i(552902),
      r = e.i(657430),
      n = e.i(195746);
    class a extends Map {
    ...
    e.s(["LruMap", () => a], 798315), e.s(["isAddress", () => i], 253082);
    ...
    function i(e, t) {
      ...
      let a = !!o.test(e) && (e.toLowerCase() === e || !r || u(e) === e);
      return s.set(n, a), a;
    }
    let c = new a(8192);
    function u(e, t) {
      if (c.has(`${e}.${t}`)) return c.get(`${e}.${t}`);
      let a = t ? `${t}${e.toLowerCase()}` : e.substring(2).toLowerCase(),
        o = (0, n.keccak256)((0, r.stringToBytes)(a), "bytes"),
        s = (t ? a.substring(`${t}0x`.length) : a).split("");
  ...
  (e) => {
    "use strict";
    e.s(["formatAbiItem", () => r, "formatAbiParams", () => n]);
    var t = e.i(788797);
    function r(e, { includeName: a = !1 } = {}) {
      if ("function" !== e.type && "event" !== e.type && "error" !== e.type)
        throw new t.InvalidDefinitionTypeError(e.type);
      return `${e.name}(${n(e.inputs, { includeName: a })})`;
    }
...
You can look up the signature here: https://openchain.xyz/signatures?query=${e}.`,
    ...
    class x extends n.BaseError {
      constructor({ abiItem: e, data: r, params: n, size: a }) {
        super(
...
Valid types: "function", "event", "error"`,
  ...
  (e) => {
    ...
    e.s(["slice", () => a, "sliceBytes", () => i, "sliceHex", () => c]);
  },
  327696,
  322124,
  769263,
  ...
  (e) => {
    ...
    e.s(["concat", () => h, "concatHex", () => m], 322124);
    var y = e.i(273407);
    let g =
            ...
            n.push(
              (function e({ param: r, value: n }) {
                  ...
                  return (function (t, { param: r }) {
                    ...
                    for (let o = 0; o < r.components.length; o++) {
                      let s = r.components[o],
                        i = Array.isArray(t) ? o : s.name,
                        c = e({ param: s, value: t[i] });
                      a.push(c), c.dynamic && (n = !0);
                    }
                    return {
                      dynamic: n,
                      encoded: n ? w(a) : h(a.map(({ encoded: e }) => e)),
                    };
                  })(n, { param: r });
                if ("address" === r.type) {
                  var c = n;
                    ...
                    if (!n) {
                      ...
                      return (
                          ...
                          })),
                        {
                          dynamic: !0,
                          encoded: h([
                            (0, y.padHex)((0, u.numberToHex)(o, { size: 32 })),
                            t,
                          ]),
                        }
                      );
                ...
                if ("string" === r.type) {
                  ...
                  for (let n = 0; n < t; n++)
                    r.push(
                      (0, y.padHex)((0, o.slice)(e, 32 * n, (n + 1) * 32), {
                        dir: "right",
                      })
                    );
                  return {
    ...
    function x(e, f) {
      ...
      for (let n = 0; n < e.length; ++n) {
        let a = e[n];
        p.setPosition(h);
        let [l, f] = (function e(n, a, { staticPosition: l }) {
          let f = E(a.type);
          if (f) {
            let [t, r] = f;
            return (function (t, r, { length: n, staticPosition: a }) {
              if (!n) {
                ...
                let s = d(t.readBytes(32)),
                  ...
                  u = [];
                for (let n = 0; n < s; ++n) {
                  t.setPosition(o + (i ? 32 * n : c));
                  let [a, s] = e(t, r, { staticPosition: o });
                  (c += s), u.push(a);
                }
              ...
              let o = 0,
                s = [];
              for (let i = 0; i < n; ++i) {
                let [n, i] = e(t, r, { staticPosition: a + o });
                (o += i), s.push(n);
              }
              return [s, o];
            })(n, { ...a, type: r }, { length: t, staticPosition: l });
          }
          if ("tuple" === a.type)
    ...
    e.s(
      ...
      e.s(["decodeAbiParameters", () => x], 327696);
  },
  98737,
  (e) => {
    "use strict";
  ...
  (e) => {
      ...
      for (let o = 0; o < a; o++)
        (t += (function e(t) {
          ...
          if (n.test(t.type) && "components" in t) {
            ...
            let s = (0, r.execTyped)(n, t.type);
            return (a += `)${s?.array ?? ""}`), e({ ...t, type: a });
          }
        ...
        (function (e) {
          ...
          for (let o = 0; o < e.length; o++) {
            ...
            if (
              ...
              if (0 === n) {
                if (" " === i && ["event", "function", ""].includes(a)) a = "";
                else if (((a += i), ")" === i)) {
                  s = !0;
                  break;
                }
          ...
          if (!s) throw new o.BaseError("Unable to normalize signature.");
          return a;
        })(
          (() =>
            "string" == typeof e
    ...
    e.s(["toSignatureHash", () => s], 703768);
  },
  314679,
  (e) => {
    "use strict";
    let t = e.i(703768).toSignatureHash;
                ...
                let r = (function e(t, r, a) {
                  for (let o in t) {
                    ...
                    if (
                      ...
                      return e(s.components, i.components, a[o]);
                    let c = [s.type, i.type];
                    if (
  ...
  (e) => {
    ...
    function o(e) {
      let { abi: o, args: s, functionName: i, data: c } = e,
        u = o[0];
      if (i) {
        let e = (0, n.getAbiItem)({ abi: o, args: s, name: i });
        if (!e) throw new t.AbiFunctionNotFoundError(i, { docsPath: a });
        u = e;
      }
      if ("function" !== u.type)
  ...
  (e) => {
          ...
          1 === e.abi.length && e.functionName?.startsWith("0x")
            ...
            : (function (e) {
                let { abi: t, args: r, functionName: c } = e,
                  u = t[0];
                if (c) {
                  let e = (0, s.getAbiItem)({ abi: t, args: r, name: c });
                  if (!e)
    ...
    e.s(["encodeFunctionData", () => c], 822616);
  },
  918089,
  (e) => {
    "use strict";
  ...
  (e) => {
    ...
    function i(e) {
      ...
      let d = [...(i || []), t.solidityError, t.solidityPanic].find(
        (e) =>
          "error" === e.type &&
          u === (0, a.toFunctionSelector)((0, s.formatAbiItem)(e))
      );
      if (!d)
    ...
    e.s(["decodeErrorResult", () => i], 817093);
    let c = (e, t, r) =>
      JSON.stringify(
        e,
        (e, r) => {
    ...
    e.s(["stringify", 0, c], 793836),
      e.s(["formatAbiItemWithArgs", () => u], 24742);
  },
  257584,
  864817,
  810907,
  ...
  (e) => {
    ...
    e.s(["etherUnits", 0, i, "gweiUnits", 0, c], 864817),
      e.s(["formatUnits", () => u], 810907),
      e.s(["formatEther", () => d], 742741),
      e.s(["formatGwei", () => l], 13366);
    var f = e.i(788797),
      b = e.i(768288),
      p = b;
...
`),
    ...
    let T = (e) => e;
    e.s(["getContractAddress", 0, T, "getUrl", 0, (e) => e], 793287);
    class I extends b.BaseError {
      constructor(
        ...
        let y = w({
          ...
          to: b,
          value:
            void 0 !== p && `${d(p)} ${a?.nativeCurrency?.symbol || "ETH"}`,
          data: o,
          gas: s,
...
${g(h)}`),
    ...
    class z extends b.BaseError {
      constructor(
        ...
        const d = (0, s.getAbiItem)({ abi: t, args: r, name: c }),
          l = d
            ...
            : void 0,
          f = d ? (0, a.formatAbiItem)(d, { includeName: !0 }) : void 0,
          b = w({
            address: n && T(n),
            function: f,
            args:
    ...
    class M extends b.BaseError {
      constructor({ abi: e, data: t, functionName: s, message: i }) {
        let c, u, d, l, b;
        if (t && "0x" !== t)
          try {
            const {
  ...
  (e) => {
    ...
    function c(e) {
      let { abi: t, data: r } = e,
        ...
        u = t.find(
          (e) =>
            "function" === e.type &&
            c === (0, o.toFunctionSelector)((0, i.formatAbiItem)(e))
        );
      if (!u)
      ...
      return {
        ...
        args:
          "inputs" in u && u.inputs && u.inputs.length > 0
            ? (0, s.decodeAbiParameters)(u.inputs, (0, a.slice)(r, 4))
            : void 0,
      };
    }
    e.s(["decodeFunctionData", () => c], 315027);
    var u = e.i(322124),
      d = e.i(188098),
      l = e.i(68245);
    ...
    function b(e) {
      let { abi: t, errorName: r, args: a } = e,
        s = t[0];
      if (r) {
        let e = (0, l.getAbiItem)({ abi: t, args: a, name: r });
        if (!e) throw new n.AbiErrorNotFoundError(r, { docsPath: f });
        s = e;
      }
      if ("error" !== s.type)
        throw new n.AbiErrorNotFoundError(void 0, { docsPath: f });
      let c = (0, i.formatAbiItem)(s),
        b = (0, o.toFunctionSelector)(c),
        p = "0x";
      if (a && a.length > 0) {
        if (!s.inputs)
          throw new n.AbiErrorInputsNotFoundError(s.name, { docsPath: f });
        p = (0, d.encodeAbiParameters)(s.inputs, a);
      }
    ...
    async function m(e) {
      ...
      return (
          ...
          s.map(async (e, n) => {
            try {
              (u[n] = e.urls.includes(h)
                ? await m({ data: e.data, ccipRequest: o })
                : await o(e)),
                (i[n] = !1);
            } catch (e) {
              var a;
        ...
        (function (e) {
          ...
          if (!o.outputs)
            throw new n.AbiFunctionOutputsNotFoundError(o.name, {
              docsPath: p,
            });
          let s = (() => {
            if (0 === o.outputs.length) return [];
            if (1 === o.outputs.length) return [a];
            if (Array.isArray(a)) return a;
            throw new n.InvalidArrayError(a);
          })();
          return (0, d.encodeAbiParameters)(o.outputs, s);
  ...
  (e) => {
    ...
    class c extends i.BaseError {
      constructor(
        e,
        { code: t, docsPath: r, metaMessages: n, name: a, shortMessage: s }
      ) {
        super(s, {
          cause: e,
          docsPath: r,
          ...
          (this.name = a || e.name),
          (this.code = e instanceof o ? e.code : t ?? -1);
      }
    }
    class u extends c {
      constructor(e, t) {
  ...
  (e) => {
    ...
    function I(e, r) {
      ...
      if (i) {
        ...
        g = { components: t };
      } else if (c.type in f) (o = "tuple"), (g = { components: f[c.type] });
      else if (T.test(c.type)) o = `${c.type}256`;
      else if ("address payable" === c.type) o = "address";
      else if (((o = c.type), r?.type !== "struct" && !M(o)))
        throw new b({ type: o });
      if (c.modifier) {
    ...
    function z(e, t = [], r = "", n = 0) {
      ...
      for (let o = 0; o < a; o++) {
        ...
        switch (a) {
          case ",":
            return 0 === n ? z(s, [...t, r.trim()]) : z(s, t, `${r}${a}`, n);
          case "(":
            return z(s, t, `${r}${a}`, n + 1);
          case ")":
            return z(s, t, `${r}${a}`, n - 1);
          default:
            return z(s, t, `${r}${a}`, n);
    ...
    let O =
      ...
      R = /^(?<type>[a-zA-Z$_][a-zA-Z0-9$_]*)(?<array>(?:\[\d*?\])+?)?$/;
    function S(e) {
      let l = (function (e) {
          let r = {},
            n = e.length;
          for (let a = 0; a < n; a++) {
            ...
            let s = (0, t.execTyped)(o, n);
            if (!s) throw new v({ signature: n, type: "struct" });
          ...
          for (let e = 0; e < i; e++) {
            ...
            a[n] = (function e(r, n, a = new Set()) {
              ...
              for (let i = 0; i < s; i++) {
                let s = r[i];
                if (t.isTupleRegex.test(s.type)) o.push(s);
                else {
                  let r = (0, t.execTyped)(R, s.type);
                  if (!r?.type) throw new g({ abiParameter: s });
                  let { array: i, type: c } = r;
                  if (c in n) {
                    if (a.has(c)) throw new x({ type: c });
                    o.push({
                      ...s,
                      type: `tuple${i ?? ""}`,
                      components: e(n[c] ?? [], n, new Set([...a, c])),
                    });
                  } else if (M(c)) o.push(s);
            ...
            (function (e, o = {}) {
              if (a.test(e))
                return (function (e, r = {}) {
                  ...
                  let o = z(n.parameters),
                    s = [],
                    i = o.length;
                  for (let e = 0; e < i; e++)
                    s.push(
                      I(o[e], { modifiers: d, structs: r, type: "function" })
                    );
                  let c = [];
                  if (n.returns) {
                    let e = z(n.returns),
              ...
              if (n.test(e))
                return (function (e, r = {}) {
                  let a = (0, t.execTyped)(n, e);
                  if (!a) throw new v({ signature: e, type: "event" });
                  let o = z(a.parameters),
                    s = [],
                    i = o.length;
                  for (let e = 0; e < i; e++)
                    s.push(
                      I(o[e], { modifiers: u, structs: r, type: "event" })
                    );
                  return { name: a.name, type: "event", inputs: s };
                })(e, o);
              if (r.test(e))
                return (function (e, n = {}) {
                  let a = (0, t.execTyped)(r, e);
                  if (!a) throw new v({ signature: e, type: "error" });
                  let o = z(a.parameters),
                    s = [],
                    i = o.length;
                  for (let e = 0; e < i; e++)
                    s.push(I(o[e], { structs: n, type: "error" }));
                  return { name: a.name, type: "error", inputs: s };
                })(e, o);
              if (s.test(e))
                return (function (e, r = {}) {
                  let n = (0, t.execTyped)(s, e);
                  if (!n) throw new v({ signature: e, type: "constructor" });
                  let a = z(n.parameters),
                    o = [],
                    i = a.length;
                  for (let e = 0; e < i; e++)
                    o.push(I(a[e], { structs: r, type: "constructor" }));
                  return {
                    type: "constructor",
                    stateMutability: n.stateMutability ?? "nonpayable",
                    inputs: o,
    ...
    class C extends Error {
      constructor(e, t = {}) {
        const r = (() => {
          ...
          n = (t.cause instanceof C && t.cause.docsPath) || t.docsPath,
          a = `https://oxlib.sh${n ?? ""}`;
        super(
          [
            e || "An error occurred.",
    ...
    function F(e, t) {
      if (W(e) > t) throw new ea({ givenSize: W(e), maxSize: t });
    }
    e.s(["BaseError", () => C], 81689);
    function j(e) {
      return e >= 48 && e <= 57
        ? e - 48
        : e >= 65 && e <= 70
      ...
      return "number" == typeof r
        ? (F(n, r),
          (function (e, t = {}) {
            ...
            if (0 === n) return e;
            if (e.length > n)
              throw new es({ size: e.length, targetSize: n, type: "Bytes" });
            let a = new Uint8Array(n);
            for (let t = 0; t < n; t++) {
              let o = "right" === r;
              a[o ? t : n - t - 1] = e[o ? t : e.length - t - 1];
    ...
    function Z(e, t, r, n = {}) {
      ...
      if ("number" == typeof t && t > 0 && t > W(e) - 1)
        throw new eo({ offset: t, position: "start", size: W(e) });
      let o = e.slice(t, r);
      return (
        a &&
          (function (e, t, r) {
            if ("number" == typeof t && "number" == typeof r && W(e) !== r - t)
              throw new eo({ offset: r, position: "end", size: W(e) });
          })(o, t, r),
        o
      );
    }
    function J(e, t = {}) {
      let { size: r } = t;
      return void 0 !== r && F(e, r), ew(ef(e, t), t);
    }
    function Y(e, t = {}) {
      let { size: r } = t,
        n = e;
      if ((void 0 !== r && (F(n, r), (n = Q(n))), n.length > 1 || n[0] > 1))
        throw new er(n);
      return !!n[0];
    }
    function K(e, t = {}) {
      let { size: r } = t;
      return void 0 !== r && F(e, r), eE(ef(e, t), t);
    }
    function X(e, t = {}) {
      let { size: r } = t,
        n = e;
      return void 0 !== r && (F(n, r), (n = ee(n))), D.decode(n);
    }
    function Q(e) {
      return N(e, { dir: "left" });
    }
    function ee(e) {
      return N(e, { dir: "right" });
    }
    function et(e) {
      try {
        if (
    ...
    function eb(e, t = {}) {
      ...
      let i = (n && o < 0 ? (1n << BigInt(8 * a)) + BigInt(o) : o).toString(16),
        c = `0x${i}`;
      return a ? eh(c, a) : c;
    }
    function ep(e, t = {}) {
    ...
    function eO(e) {
      return {
        ...
        ...(e.withdrawals && { withdrawals: e.withdrawals.map(eM) }),
      };
    }
    e.s(["toRpc", () => eO], 393348);
  },
  ...
  (e) => {
    "use strict";
    e.s(["aggregate3Signature", 0, "0x82ad56cb"], 236492),
      e.s(
        [
  ...
  (e) => {
    ...
    function o(e) {
      ...
      let u = (0, n.encodeAbiParameters)(c.inputs, s);
...
Try increasing the nonce or find the latest nonce with \`getTransactionCount\`.`,
  ...
  (e) => {
    ...
    function y(e, { docsPath: t, ...r }) {
      let n,
        a = (n = m(e, r)) instanceof h.UnknownNodeError ? e : n;
      return new u.CallExecutionError(a, { docsPath: t, ...r });
    }
    ...
    e.i(966629),
      e.i(804633),
      e.s(["getNodeError", () => m], 559574),
      e.s(["getCallError", () => y], 553748),
      e.s(["extract", () => g], 650791),
      e.s(["defineFormatter", () => v], 617568);
    let w = {
      legacy: "0x0",
      eip2930: "0x1",
      eip1559: "0x2",
    ...
    e.s(["formatTransactionRequest", () => E], 821554),
      e.s(["withResolvers", () => x], 530666);
    let $ = new Map();
    function A({ fn: e, id: t, shouldSplitBatch: r, wait: n = 0, sort: a }) {
      let o = async () => {
          let t = i();
          s();
      ...
      return {
        flush: s,
        async schedule(e) {
          let { promise: t, resolve: a, reject: s } = x();
          return (
            (r?.([...i().map(({ args: e }) => e), e]) && o(), i().length > 0)
              ? c({ args: e, resolve: a, reject: s })
              : (c({ args: e, resolve: a, reject: s }), setTimeout(o, n)),
            t
          );
        },
      };
    }
    e.s(["createBatchScheduler", () => A], 271355);
    var P = e.i(552902),
      B = e.i(103140),
      T = e.i(45268),
      I = e.i(253082);
    ...
    function M(e) {
      ...
      for (let { address: r, ...n } of e) {
        ...
        t[r] = (function (e) {
          let { balance: t, nonce: r, state: n, stateDiff: a, code: o } = e,
            s = {};
          if (
            (void 0 !== o && (s.code = o),
            void 0 !== t && (s.balance = (0, p.numberToHex)(t)),
            void 0 !== r && (s.nonce = (0, p.numberToHex)(r)),
            void 0 !== n && (s.state = z(n)),
            void 0 !== a)
          ) {
            if (s.state) throw new T.StateAssignmentConflictError();
            s.stateDiff = z(a);
          }
          return s;
        })(n);
    ...
    e.s(["serializeStateOverride", () => M], 201282);
    let O = 2n ** 256n - 1n;
    function R(e) {
      let { account: t, maxFeePerGas: r, maxPriorityFeePerGas: a, to: o } = e,
        s = t ? (0, n.parseAccount)(t) : void 0;
      if (s && !(0, I.isAddress)(s.address))
        throw new P.InvalidAddressError({ address: s.address });
      if (o && !(0, I.isAddress)(o))
    ...
    async function S(a, d) {
      let {
          ...
          blockNumber: m,
          blockTag: v = a.experimental_blockTag ?? "latest",
          accessList: w,
          blobs: x,
          blockOverrides: $,
          code: A,
      ...
      try {
        ...
        let t = ("bigint" == typeof m ? (0, p.numberToHex)(m) : void 0) || v,
          n = $ ? r.toRpc($) : void 0,
          s = M(U),
          i = a.chain?.formatters?.transactionRequest?.format,
          u = (i || E)(
            {
              ...g(D, { format: i }),
              accessList: w,
        ...
        if (
          ...
          try {
            return await C(a, { ...u, blockNumber: m, blockTag: v });
          } catch (e) {
            if (
        ...
        let l =
            ((e = [u, t]),
            s && n ? [...e, s, n] : s ? [...e, s] : n ? [...e, {}, n] : e),
          f = await a.request({ method: "eth_call", params: l });
        ...
        let t = (function (e) {
          ...
          { offchainLookup: r, offchainLookupSignature: n } = await e.A(637970);
        if (!1 !== a.ccipRead && t?.slice(0, 10) === n && k)
          return { data: await r(a, { data: t, to: k }) };
        if (q && t?.slice(0, 10) === "0x101bb98d")
          throw new u.CounterfactualDeploymentFailedError({ factory: B });
        throw y(o, { ...d, account: L, chain: a.chain });
      }
    }
            ...
            let r = t.map((e) => ({
              ...
              o = await e.request({
                ...
                params: [
                  {
                    ...(null === y
                      ? { data: F({ code: s.multicall3Bytecode, data: n }) }
                      : { to: y, data: n }),
                  },
                  g,
                ],
    ...
    function j(e, t) {
      if (!(0, I.isAddress)(e, { strict: !1 }))
        throw new P.InvalidAddressError({ address: e });
      if (!(0, I.isAddress)(t, { strict: !1 }))
        throw new P.InvalidAddressError({ address: t });
      return e.toLowerCase() === t.toLowerCase();
    }
    e.s(["assertRequest", () => R], 60761),
      e.s(["call", () => S], 625187),
      e.s(["isAddressEqual", () => j], 158836);
  },
]);
