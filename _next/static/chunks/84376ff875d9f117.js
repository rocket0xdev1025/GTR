(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function o(e, s = {}) {
      ...
      if (!n.test(e)) {
        if (s.strict) throw SyntaxError("[destr] Invalid JSON");
        return e;
      }
      try {
        if (t.test(e) || r.test(e)) {
          if (s.strict) throw Error("[destr] Possible prototype pollution");
    ...
    Object.defineProperty(a, "defaultMaxListeners", {
      ...
      (a.prototype.emit = function (e) {
        ...
        if ("function" == typeof u) o(u, this, t);
          ...
          for (var l = u.length, c = y(u, l), r = 0; r < l; ++r)
            o(c[r], this, t);
        return !0;
      }),
  ...
  (e, t, r) => {
    ...
    Object.defineProperty(r, "__esModule", { value: !0 });
    let n = e.r(787267);
    n.__exportStar(e.r(945011), r), n.__exportStar(e.r(964194), r);
  },
  652969,
  (e, t, r) => {
    "use strict";
  ...
  (e, t, r) => {
    ...
    Object.defineProperty(r, "__esModule", { value: !0 });
    let n = e.r(787267);
    n.__exportStar(e.r(417459), r), n.__exportStar(e.r(652969), r);
  },
  345382,
  (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", { value: !0 }), (r.Watch = void 0);
    class n {
      constructor() {
  ...
  (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", { value: !0 }),
      e.r(787267).__exportStar(e.r(208055), r);
  },
  648512,
  (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", { value: !0 });
    let n = e.r(787267);
    n.__exportStar(e.r(497525), r),
      n.__exportStar(e.r(345382), r),
      n.__exportStar(e.r(663134), r),
      n.__exportStar(e.r(881927), r);
  },
  36610,
  (e, t, r) => {
    "use strict";
  ...
  (e) => {
    ...
    function h(e) {
      ...
      var f = a[1] && a[1].split(".").join("_").split("_").slice(0, 3);
      f
        ? f.length < 3 &&
          (f = r(
            r([], f, !0),
      ...
      var h = f.join("."),
        ...
        p = u.exec(e);
      return p && p[1] ? new o(i, h, d, p[1]) : new n(i, h, d);
    }
    e.s(["detect", () => f], 277945);
    let d = (function (e) {
  ...
  (e) => {
    ...
    e.s(["safeJsonParse", () => t, "safeJsonStringify", () => r]);
  },
  121609,
  (e) => {
    "use strict";
    ...
    function h(e = 32) {
      if (u && "function" == typeof u.getRandomValues)
        return u.getRandomValues(new Uint8Array(e));
      if (u && "function" == typeof u.randomBytes) return u.randomBytes(e);
    ...
    class d extends f {
      ...
      digestInto(e) {
        ...
        for (let e = 0; e < f; e++) u.setUint32(4 * e, h[e], i);
      }
      digest() {
    ...
    let p = BigInt(0x100000000 - 1),
      ...
      w = (e, t, r) => (e >>> (r - 32)) | (t << (64 - r)),
      E = function (e, t, r, n) {
        let i = (t >>> 0) + (n >>> 0);
        return { h: (e + r + ((i / 0x100000000) | 0)) | 0, l: 0 | i };
      },
      x = (e, t, r) => (e >>> 0) + (t >>> 0) + (r >>> 0),
      _ = (e, t, r, n) => (t + r + n + ((e / 0x100000000) | 0)) | 0,
      O = (e, t, r, n) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0),
      ...
      [I, B] = (function (e, t = !1) {
        ...
        for (let i = 0; i < e.length; i++) {
          let { h: o, l: s } = (function (e, t = !1) {
            return t
              ? { h: Number(e & p), l: Number((e >> b) & p) }
              : { h: 0 | Number((e >> b) & p), l: 0 | Number(e & p) };
          })(e[i], t);
          [r[i], n[i]] = [o, s];
        }
        return [r, n];
    ...
    class L extends d {
      ...
      process(e, t) {
        for (let r = 0; r < 16; r++, t += 4)
          (T[r] = e.getUint32(t)), (P[r] = e.getUint32((t += 4)));
        for (let e = 16; e < 80; e++) {
          let t = 0 | T[e - 15],
            r = 0 | P[e - 15],
            n = m(t, r, 1) ^ m(t, r, 8) ^ y(t, r, 7),
            i = v(t, r, 1) ^ v(t, r, 8) ^ g(t, r, 7),
            o = 0 | T[e - 2],
            s = 0 | P[e - 2],
            a = m(o, s, 19) ^ D(o, s, 61) ^ y(o, s, 6),
            u = O(
              i,
              v(o, s, 19) ^ w(o, s, 61) ^ g(o, s, 6),
              P[e - 7],
              P[e - 16]
            ),
            l = S(u, n, a, T[e - 7], T[e - 16]);
          (T[e] = 0 | l), (P[e] = 0 | u);
        }
        let {
          Ah: r,
        ...
        for (let e = 0; e < 80; e++) {
          let t = m(c, f, 14) ^ m(c, f, 18) ^ D(c, f, 41),
            y = v(c, f, 14) ^ v(c, f, 18) ^ w(c, f, 41),
            g = (c & h) ^ (~c & p),
            O = C(N, y, (f & d) ^ (~f & b), B[e], P[e]),
            S = A(O, L, t, g, I[e], T[e]),
            U = 0 | O,
            j = m(r, n, 28) ^ D(r, n, 34) ^ D(r, n, 39),
            R = v(r, n, 28) ^ w(r, n, 34) ^ w(r, n, 39),
            k = (r & i) ^ (r & s) ^ (i & s),
            M = (n & o) ^ (n & a) ^ (o & a);
          (L = 0 | p),
            (N = 0 | b),
        ...
        ({ h: r, l: n } = E(0 | this.Ah, 0 | this.Al, 0 | r, 0 | n)),
          ({ h: i, l: o } = E(0 | this.Bh, 0 | this.Bl, 0 | i, 0 | o)),
          ({ h: s, l: a } = E(0 | this.Ch, 0 | this.Cl, 0 | s, 0 | a)),
          ({ h: u, l: l } = E(0 | this.Dh, 0 | this.Dl, 0 | u, 0 | l)),
          ({ h: c, l: f } = E(0 | this.Eh, 0 | this.El, 0 | c, 0 | f)),
          ({ h: h, l: d } = E(0 | this.Fh, 0 | this.Fl, 0 | h, 0 | d)),
          ({ h: p, l: b } = E(0 | this.Gh, 0 | this.Gl, 0 | p, 0 | b)),
          ({ h: L, l: N } = E(0 | this.Hh, 0 | this.Hl, 0 | L, 0 | N)),
          this.set(r, n, i, o, s, a, u, l, c, f, h, d, p, b, L, N);
      }
      roundClean() {
        T.fill(0), P.fill(0);
      }
    ...
    let N =
        ((n = () => new L()),
        ((t = (e) => n().update(c(e)).digest()).outputLen = (r =
          n()).outputLen),
    ...
    function M(e) {
      if (!k(e)) throw Error("Uint8Array expected");
    }
    function F(e, t) {
      if ("boolean" != typeof t) throw Error(e + " boolean expected, got " + t);
    }
    let z = Array.from({ length: 256 }, (e, t) =>
      t.toString(16).padStart(2, "0")
    );
    function W(e) {
      M(e);
      let t = "";
      for (let r = 0; r < e.length; r++) t += z[e[r]];
      return t;
    }
    function H(e) {
      if ("string" != typeof e)
        throw Error("hex string expected, got " + typeof e);
      return "" === e ? U : BigInt("0x" + e);
    }
    function V(e) {
      return e >= 48 && e <= 57
        ? e - 48
    ...
    function K(e) {
      return M(e), H(W(Uint8Array.from(e).reverse()));
    }
    function $(e, t) {
    ...
    function Y(e, t, r) {
      ...
      else if (k(t)) n = Uint8Array.from(t);
    ...
    let Z = (e) => "bigint" == typeof e && U <= e;
    function X(e, t, r, n) {
      if (!(Z(t) && Z(r) && Z(n)) || !(r <= t) || !(t < n))
        throw Error(
    ...
    let Q = {
      ...
      stringOrUint8Array: (e) => "string" == typeof e || k(e),
    ...
    function ef(e, t) {
      ...
      if (n !== en) throw Error("invert: does not exist");
      return el(i, t);
    }
    let eh = [
      "create",
      ...
      let a = Object.freeze({
        ...
        pow: (e, t) =>
          (function (e, t, r) {
            ...
            let n = e.ONE,
              i = t;
            for (; r > er; )
              r & en && (n = e.mul(n, i)), (i = e.sqr(i)), (r >>= en);
            return n;
          })(a, e, t),
        div: (t, r) => el(t * ef(r, e), e),
        sqrN: (e) => e * e,
        addN: (e, t) => e + t,
        subN: (e, t) => e - t,
        mulN: (e, t) => e * t,
                ...
                return (function (e) {
                  ...
                  return function (e, s) {
                    ...
                    for (; !e.eql(c, e.ONE); ) {
                      ...
                      let t = 1;
                      for (let r = e.sqr(c); t < a && !e.eql(r, e.ONE); t++)
                        r = e.sqr(r);
                      let r = e.pow(u, en << BigInt(a - t - 1));
                      (u = e.sqr(r)),
                        (l = e.mul(l, r)),
                        (c = e.mul(c, u)),
                        (a = t);
        ...
        invertBatch: (e) => {
          ...
          return (
            (t = Array(e.length)),
            (r = e.reduce(
              (e, r, n) => (a.is0(r) ? e : ((t[n] = e), a.mul(e, r))),
              a.ONE
            )),
            (n = a.inv(r)),
            e.reduceRight(
              (e, r, n) =>
                a.is0(r) ? e : ((t[n] = a.mul(e, t[n])), a.mul(e, r)),
              n
            ),
            t
          );
      ...
      eU = (function (e) {
          ...
          p =
            ...
            ((e, t) => {
              try {
                ...
                return { isValid: !1, value: ex };
              }
            }),
          b = n.adjustScalarBytes || ((e) => e),
          y =
            n.domain ||
            ((e, t, r) => {
              if ((F("phflag", r), t.length || r))
                throw Error("Contexts/pre-hash are not supported");
              return e;
            });
        function g(e, t) {
          X("coordinate " + e, t, ex, f);
        }
        function m(e) {
        ...
        let v = et((e, t) => {
            let { ex: r, ey: n, ez: o } = e,
              s = e.is0();
            null == t && (t = s ? eS : i.inv(o));
            let a = h(r * t),
              u = h(n * t),
              l = h(o * t);
            if (s) return { x: ex, y: e_ };
            if (l !== e_) throw Error("invZ was invalid");
            return { x: a, y: u };
          }),
          D = et((e) => {
            let { a: t, d: r } = n;
        ...
        class w {
          ...
          static fromAffine(e) {
            ...
            let { x: t, y: r } = e || {};
            return g("x", t), g("y", r), new w(t, r, e_, h(t * r));
          }
          static normalizeZ(e) {
          ...
          double() {
            let { a: e } = n,
              ...
              y = h(f * p),
              g = h(c * p);
            return new w(b, y, h(d * f), g);
          }
          add(e) {
            m(e);
            let { a: t, d: r } = n,
              { ex: i, ey: o, ez: s, et: a } = this,
              { ex: u, ey: l, ez: c, et: f } = e;
            if (t === BigInt(-1)) {
              let e = h((o - i) * (l + u)),
                t = h((o + i) * (l - u)),
                r = h(t - e);
              if (r === ex) return this.double();
              let n = h(s * eO * f),
                d = h(a * eO * c),
                p = d + n,
                b = t + e,
            ...
            let d = h(i * u),
              ...
              _ = h(D * E),
              O = h(g * E);
            return new w(x, _, h(v * D), O);
          }
          subtract(e) {
            return this.add(e.negate());
          }
          wNAF(e) {
            return _.wNAFCached(this, e, w.normalizeZ);
          }
          multiply(e) {
            X("scalar", e, e_, o);
          ...
          multiplyUnsafe(e, t = w.ZERO) {
            return (
              ...
              e === ex
                ...
                : this.is0() || e === e_
                ? this
                : _.wNAFCachedUnsafe(this, e, w.normalizeZ, t)
            );
          }
          isSmallOrder() {
          ...
          isTorsionFree() {
            return _.unsafeLadder(this, o).is0();
          }
          toAffine(e) {
            return v(this, e);
          }
          clearCofactor() {
            let { h: e } = n;
            return e === e_ ? this : this.multiplyUnsafe(e);
          }
          static fromHex(e, t = !1) {
            let { d: r, a: o } = n,
              s = i.BYTES;
            (e = Y("pointHex", e, s)), F("zip215", t);
            let a = e.slice(),
              u = e[s - 1];
            a[s - 1] = -129 & u;
            let l = K(a);
            X("pointHex.y", l, ex, t ? f : i.ORDER);
            let c = h(l * l),
              { isValid: d, value: b } = p(h(c - e_), h(r * c - o));
            if (!d) throw Error("Point.fromHex: invalid y coordinate");
            let y = (b & e_) === e_,
              g = (128 & u) != 0;
            if (!t && b === ex && g)
              throw Error("Point.fromHex: x=0 and x_0=1");
            return g !== y && (b = h(-b)), w.fromAffine({ x: b, y: l });
          }
          ...
          toRawBytes() {
            let { x: e, y: t } = this.toAffine(),
              r = J(t, i.BYTES);
            return (r[r.length - 1] |= e & e_ ? 128 : 0), r;
          }
          toHex() {
            return W(this.toRawBytes());
          }
        }
        (w.BASE = new w(n.Gx, n.Gy, e_, h(n.Gx * n.Gy))),
          (w.ZERO = new w(ex, e_, e_, ex));
        let { BASE: E, ZERO: x } = w,
          _ =
            ((t = 8 * l),
            {
              constTimeNegate: eg,
              hasPrecomputes: (e) => 1 !== eE(e),
              unsafeLadder(e, t, r = w.ZERO) {
                let n = e;
                for (; t > eb; )
                  t & ey && (r = r.add(n)), (n = n.double()), (t >>= ey);
                return r;
              },
              precomputeWindow(e, r) {
                let { windows: n, windowSize: i } = ev(r, t),
                  o = [],
                  s = e,
                  a = s;
                for (let e = 0; e < n; e++) {
              ...
              wNAF(e, r, n) {
                let { windows: i, windowSize: o } = ev(e, t),
                  s = w.ZERO,
                  a = w.BASE,
                  u = BigInt(2 ** e - 1),
                  l = 2 ** e,
                ...
                for (let e = 0; e < i; e++) {
                  ...
                  let f = t + Math.abs(i) - 1,
                    h = e % 2 != 0,
                    d = i < 0;
                  0 === i ? (a = a.add(eg(h, r[t]))) : (s = s.add(eg(d, r[f])));
                }
                return { p: s, f: a };
              },
              wNAFUnsafe(e, r, n, i = w.ZERO) {
                let { windows: o, windowSize: s } = ev(e, t),
                  a = BigInt(2 ** e - 1),
                  u = 2 ** e,
                  l = BigInt(e);
                for (let e = 0; e < o; e++) {
              ...
              setWindowSize(e, r) {
                em(r, t), ew.set(e, r), eD.delete(e);
              },
            });
        function O(e) {
          let t = i.BYTES;
          e = Y("private key", e, t);
          let r = Y("hashed private key", a(e), 2 * t),
            n = b(r.slice(0, t)),
            s = r.slice(t, 2 * t),
            u = el(K(n), o),
            l = E.multiply(u),
            c = l.toRawBytes();
          return { head: n, prefix: s, scalar: u, point: l, pointBytes: c };
        }
        function S(e = new Uint8Array(), ...t) {
          return el(K(a(y(G(...t), Y("context", e), !!s))), o);
        }
        return (
          E._setWindowSize(8),
          {
            ...
            sign: function (e, t, r = {}) {
              (e = Y("message", e)), s && (e = s(e));
              let { prefix: n, scalar: a, pointBytes: u } = O(t),
                l = S(r.context, n, e),
                c = E.multiply(l).toRawBytes(),
                f = el(l + S(r.context, c, u, e) * a, o);
              return (
                X("signature.s", f, ex, o),
                Y("result", G(c, J(f, i.BYTES)), 2 * i.BYTES)
              );
            },
            verify: function (e, t, r, n = eA) {
              let o,
                a,
                u,
                { context: l, zip215: c } = n,
                f = i.BYTES;
              (e = Y("signature", e, 2 * f)),
                (t = Y("message", t)),
                (r = Y("publicKey", r, f)),
                void 0 !== c && F("zip215", c),
                s && (t = s(t));
              let h = K(e.slice(f, 2 * f));
              try {
                (o = w.fromHex(r, c)),
                  (a = w.fromHex(e.slice(0, f), c)),
                  (u = E.multiplyUnsafe(h));
              } catch {
                return !1;
              }
              if (!c && o.isSmallOrder()) return !1;
              let d = S(l, a.toRawBytes(), o.toRawBytes(), t);
              return a
                .add(o.multiplyUnsafe(d))
                .subtract(u)
                .clearCofactor()
                .equals(w.ZERO);
            },
        ...
        uvRatio: function (e, t) {
          ...
          let n,
            ...
            (b = (ec(p, s, eC) * d) % eC),
            (y = (ec(b, n, eC) * c) % eC),
            { pow_p_5_8: (ec(y, eT, eC) * r) % eC, b2: a }).pow_p_5_8,
            v = el(e * g * m, eC),
            D = el(t * v * v, eC),
            w = v,
            E = el(v * eI, eC),
    ...
    var eH = function (e, t) {
      ...
      function f(e) {
        ...
        if (" " !== e[0]) {
          ...
          for (
            var o = ((e.length - t) * l + 1) >>> 0, s = new Uint8Array(o);
            e[t];
      ...
      return {
        encode: function (t) {
          ...
          for (var r = 0, n = 0, i = 0, o = t.length; i !== o && 0 === t[i]; )
            i++, r++;
          for (
            var s = ((o - i) * c + 1) >>> 0, l = new Uint8Array(s);
            i !== o;
    ...
    class eY {
      constructor(e, t, r, n) {
        (this.name = e),
          ...
          (this.baseEncode = r),
          (this.baseDecode = n),
          (this.encoder = new eq(e, t, r)),
          (this.decoder = new eK(e, t, n));
      }
      encode(e) {
    ...
    let eG = ({ name: e, prefix: t, encode: r, decode: n }) =>
        new eY(e, t, r, n),
      eZ = ({ prefix: e, name: t, alphabet: r }) => {
        let { encode: n, decode: i } = eH(r, t);
        return eG({ prefix: e, name: t, encode: n, decode: (e) => eV(i(e)) });
      },
      eX = ({ name: e, prefix: t, bitsPerChar: r, alphabet: n }) =>
        eG({
          prefix: t,
          name: e,
          encode: (e) =>
    ...
    var eQ = Object.freeze({
      ...
      e3 = Object.freeze({
        __proto__: null,
        base10: eZ({ prefix: "9", name: "base10", alphabet: "0123456789" }),
      }),
      e8 = Object.freeze({
        __proto__: null,
        base16: eX({
    ...
    function tr(e, t, r) {
      ...
      return (t[r] = 0 | e), (tr.bytes = r - n + 1), t;
    }
    var tn = function (e) {
      return e < 128
        ? 1
    ...
    let ti = (e, t, r = 0) => (tr(e, t, r), t),
      to = (e, t) => {
        let r = t.byteLength,
          n = tn(e),
          i = n + tn(r),
          o = new Uint8Array(i + r);
        return ti(e, o, 0), ti(r, o, n), o.set(t, i), new ts(e, r, t, o);
      };
    class ts {
      constructor(e, t, r, n) {
    ...
    let ta = ({ name: e, code: t, encode: r }) => new tu(e, t, r);
    class tu {
      constructor(e, t, r) {
    ...
    var tc = Object.freeze({
        __proto__: null,
        sha256: ta({ name: "sha2-256", code: 18, encode: tl("SHA-256") }),
        sha512: ta({ name: "sha2-512", code: 19, encode: tl("SHA-512") }),
      }),
      tf = Object.freeze({
        __proto__: null,
        identity: {
    ...
    let tp = td(
      ...
      tb = td(
        ...
        (e) => {
          let t = ez((e = e.substring(1)).length);
    ...
    function tv(e) {
      return (0, o.safeJsonParse)(tg(tm(e, ej), eR));
    }
    function tD(e) {
      return tg(tm((0, o.safeJsonStringify)(e), eR), ej);
    }
    function tw(e) {
      return ["did:key", "z" + tg(eW([tm("K36", eM), e]), eM)].join(":");
    }
    function tE(e) {
      let t = e.split(".");
      return {
        ...
        payload: tv(t[1]),
        signature: tm(t[2], ej),
        data: tm(t.slice(0, 2).join("."), ek),
      };
    }
    function tx(e = h(32)) {
      let t = eU.getPublicKey(e);
      return { secretKey: eW([e, t]), publicKey: t };
    }
    async function t_(e, t, r, n, o = (0, i.fromMiliseconds)(Date.now())) {
      let s = { alg: "EdDSA", typ: "JWT" },
        a = { iss: tw(n.publicKey), sub: e, aud: t, iat: o, exp: o + r },
        u = tm(
          [tD((l = { header: s, payload: a }).header), tD(l.payload)].join("."),
          ek
        );
      var l,
        c = {
          header: s,
          payload: a,
          signature: eU.sign(u, n.secretKey.slice(0, 32)),
        };
      return [tD(c.header), tD(c.payload), tg(c.signature, ej)].join(".");
    }
    e.s([
      "decodeJWT",
      () => tE,
  ...
  (e) => {
    ...
    let t = function (e, t) {
      ...
      r = new Uint8Array(0),
      n = (e) => e.reduce((e, t) => e + t.toString(16).padStart(2, "0"), ""),
      i = (e) => {
        let t = e.match(/../g);
    ...
    let b = ({ name: e, prefix: t, encode: r, decode: n }) => new p(e, t, r, n),
      y = ({ prefix: e, name: r, alphabet: n }) => {
        let { encode: i, decode: o } = t(n, r);
        return b({ prefix: e, name: r, encode: i, decode: (e) => s(o(e)) });
      },
      g = ({ name: e, prefix: t, bitsPerChar: r, alphabet: n }) =>
        b({
          prefix: t,
          name: e,
          encode: (e) =>
    ...
    e.s(["identity", 0, m], 909184);
    var v = e.i(909184);
    let D = g({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
    e.s(["base2", 0, D], 347043);
    var w = e.i(347043);
    let E = g({
      prefix: "7",
      name: "base8",
    ...
    e.s(["base8", 0, E], 209626);
    var x = e.i(209626);
    let _ = y({ prefix: "9", name: "base10", alphabet: "0123456789" });
    e.s(["base10", 0, _], 238593);
    var O = e.i(238593);
    let S = g({
        prefix: "f",
        name: "base16",
    ...
    e.s(["base16", 0, S, "base16upper", 0, A], 967748);
    var C = e.i(967748);
    let I = g({
        prefix: "b",
        name: "base32",
    ...
    e.s(["base36", 0, M, "base36upper", 0, F], 133198);
    var z = e.i(133198);
    let W = y({
        name: "base58btc",
        prefix: "z",
    ...
    e.s(["base58btc", 0, W, "base58flickr", 0, H], 201366);
    var V = e.i(201366);
    let q = g({
        prefix: "m",
        name: "base64",
    ...
    let G = Array.from(
      ...
      Z = G.reduce((e, t, r) => ((e[r] = t), e), []),
      X = G.reduce((e, t, r) => ((e[t.codePointAt(0)] = r), e), []),
      Q = b({
        prefix: "\uD83D\uDE80",
        name: "base256emoji",
        encode: function (e) {
          return e.reduce((e, t) => (e += Z[t]), "");
        },
        decode: function (e) {
          let t = [];
          for (let r of e) {
            let e = X[r.codePointAt(0)];
            if (void 0 === e) throw Error(`Non-base256emoji character: ${r}`);
            t.push(e);
          }
          return new Uint8Array(t);
    ...
    function et(e, t, r) {
      ...
      for (var n = (r = r || 0); e >= 0x80000000; )
        (t[r++] = (255 & e) | 128), (e /= 128);
      for (; -128 & e; ) (t[r++] = (255 & e) | 128), (e >>>= 7);
      return (t[r] = 0 | e), (et.bytes = r - n + 1), t;
    }
    function er(e, t) {
      var r,
        n = 0,
      ...
      do {
        if (o >= s)
          throw ((er.bytes = 0), RangeError("Could not decode varint"));
        (r = e[o++]),
          (n += i < 28 ? (127 & r) << i : (127 & r) * Math.pow(2, i)),
          (i += 7);
      } while (r >= 128);
      return (er.bytes = o - t), n;
    }
    let en = (e, t = 0) => [er(e, t), er.bytes],
      ei = (e, t, r = 0) => (et(e, t, r), t),
      eo = (e) => {
        var t;
        return (t = e) < 128
          ? 1
    ...
    e.s(["decode", 0, en, "encodeTo", 0, ei, "encodingLength", 0, eo], 632833);
    let es = (e, t) => {
        let r = t.byteLength,
          n = eo(e),
          i = n + eo(r),
          o = new Uint8Array(i + r);
        return ei(e, o, 0), ei(r, o, n), o.set(t, i), new el(e, r, t, o);
      },
      ea = (e) => {
        let t = s(e),
          [r, n] = en(t),
        ...
        return new el(r, i, a, t);
      },
      eu = (e, t) =>
        e === t ||
        (e.code === t.code && e.size === t.size && o(e.bytes, t.bytes));
    class el {
      constructor(e, t, r, n) {
        (this.code = e), (this.size = t), (this.digest = r), (this.bytes = n);
      }
    ...
    e.s(
      ["Digest", () => el, "create", 0, es, "decode", 0, ea, "equals", 0, eu],
      241823
    );
    let ec = ({ name: e, code: t, encode: r }) => new ef(e, t, r);
    class ef {
      constructor(e, t, r) {
        (this.name = e), (this.code = t), (this.encode = r);
      }
      digest(e) {
        if (e instanceof Uint8Array) {
          ...
          return t instanceof Uint8Array
            ? es(this.code, t)
            : t.then((e) => es(this.code, e));
        }
        throw Error("Unknown type, must be binary type");
      }
    }
    e.s(["Hasher", () => ef, "from", 0, ec], 529451);
    let eh = (e) => async (t) =>
        new Uint8Array(await crypto.subtle.digest(e, t)),
      ed = ec({ name: "sha2-256", code: 18, encode: eh("SHA-256") }),
      ep = ec({ name: "sha2-512", code: 19, encode: eh("SHA-512") });
    e.s(["sha256", 0, ed, "sha512", 0, ep], 609583);
    e.i(609583);
    e.s(
      [
        "identity",
        0,
        { code: 0, name: "identity", encode: s, digest: (e) => es(0, s(e)) },
      ],
      373173
    );
    e.i(373173);
    ...
    e.s(
      [
        ...
        "decode",
        0,
        (e) => JSON.parse(ey.decode(e)),
        "encode",
        0,
        (e) => eb.encode(JSON.stringify(e)),
        "name",
        0,
        "json",
      ],
    ...
    class eg {
      ...
      toV0() {
        if (0 === this.version) return this;
        {
          ...
          if (e !== ew) throw Error("Cannot convert a non dag-pb CID to CIDv0");
          if (t.code !== eE)
            throw Error("Cannot convert non sha2-256 multihash CID to CIDv0");
          return eg.createV0(t);
        }
      }
      toV1() {
        switch (this.version) {
          case 0: {
            let { code: e, digest: t } = this.multihash,
              r = es(e, t);
            return eg.createV1(this.code, r);
          }
          case 1:
            return this;
          default:
      ...
      equals(e) {
        return (
          ...
          eu(this.multihash, e.multihash)
        );
      }
      toString(e) {
        let { bytes: t, version: r, _baseCache: n } = this;
        return 0 === r ? ev(t, n, e || W.encoder) : eD(t, n, e || I.encoder);
      }
      toJSON() {
        return {
          code: this.code,
      ...
      static isCID(e) {
        return eA(/^0\.0/, eC), !!(e && (e[e_] || e.asCID === e));
      }
      ...
      static asCID(e) {
        ...
        if (null != e && e.asCID === e) {
          ...
          return new eg(t, r, n, i || ex(t, r, n.bytes));
        }
        if (null == e || !0 !== e[e_]) return null;
        {
          let { version: t, multihash: r, code: n } = e,
            i = ea(r);
          return eg.create(t, n, i);
        }
      }
      static create(e, t, r) {
        if ("number" != typeof t)
        ...
        switch (e) {
          case 0:
            if (t === ew) return new eg(e, t, r, r.bytes);
            throw Error(
              `Version 0 CID must use dag-pb (code: ${ew}) block encoding`
            );
          case 1: {
            let n = ex(e, t, r.bytes);
      ...
      static createV0(e) {
        return eg.create(0, ew, e);
      }
      static createV1(e, t) {
        return eg.create(1, e, t);
      }
      static decode(e) {
        let [t, r] = eg.decodeFirst(e);
        if (r.length) throw Error("Incorrect length");
        return t;
      }
      static decodeFirst(e) {
        let t = eg.inspectBytes(e),
          r = t.size - t.multihashSize,
          n = s(e.subarray(r, r + t.multihashSize));
        if (n.byteLength !== t.multihashSize) throw Error("Incorrect length");
        let i = n.subarray(t.multihashSize - t.digestSize),
          o = new el(t.multihashCode, t.digestSize, i, n);
        return [
          0 === t.version ? eg.createV0(o) : eg.createV1(t.codec, o),
          e.subarray(t.size),
        ];
      }
    ...
    let em = (e, t) => {
        switch (e[0]) {
          case "Q": {
            let r = t || W;
            return [W.prefix, r.decode(`${W.prefix}${e}`)];
          }
          case W.prefix: {
            let r = t || W;
            return [W.prefix, r.decode(e)];
          }
          case I.prefix: {
            let r = t || I;
            return [I.prefix, r.decode(e)];
          }
          default:
            if (null == t)
              throw Error(
      ...
      ex = (e, t, r) => {
        ...
        return ei(e, o, 0), ei(t, o, n), o.set(r, i), o;
      },
      e_ = Symbol.for("@ipld/js-cid/CID"),
      eO = { writable: !1, configurable: !1, enumerable: !0 },
      eS = { writable: !1, enumerable: !1, configurable: !1 },
      eA = (e, t) => {
...
`;
    e.i(632833), e.i(723472), e.i(529451), e.i(241823);
    let eI = { ...v, ...w, ...x, ...O, ...C, ...k, ...z, ...V, ...Y, ...ee };
    e.s(["bases", () => eI], 18531);
    let eB = {
      waku: {
  ...
  (e) => {
    ...
    var t = e.i(219298),
      r = e.i(648512);
    class n {}
    e.s(["IEvents", () => n], 81775), e.s([], 826606);
    class i extends n {
      constructor(e) {
        super();
      }
    }
    let o = r.FIVE_SECONDS,
    ...
    class a extends i {
      ...
      async initialize() {
        this.intervalRef = setInterval(
          () => this.pulse(),
          (0, r.toMiliseconds)(this.interval)
        );
      }
      pulse() {
    ...
    e.s(["HEARTBEAT_EVENTS", () => s, "HeartBeat", () => a], 180476);
  },
  65123,
  815943,
  (e) => {
    ...
    function o(e) {
      let t, r;
      if (((t = typeof e), null === e || ("object" !== t && "function" !== t)))
        return String(e);
      if (
        !(r = Object.getPrototypeOf(e)) ||
        r.isPrototypeOf(Object) ||
        Array.isArray(e)
      )
    ...
    function l(e = {}) {
      let t,
        ...
        d = (e) => {
          ...
          return { base: "", relativeKey: e, driver: h.mounts[""] };
        },
        p = (e, t) =>
          h.mountpoints
            .filter((r) => r.startsWith(e) || (t && e.startsWith(r)))
            .map((t) => ({
        ...
        b = (e, t) => {
          if (h.watching) for (let r of ((t = a(t)), h.watchListeners)) r(e, t);
        },
        y = async () => {
          if (!h.watching)
            for (let e in ((h.watching = !0), h.mounts))
              h.unwatch[e] = await c(h.mounts[e], b, e);
        },
        g = async () => {
          if (h.watching) {
            for (let e in h.unwatch) await h.unwatch[e]();
            (h.unwatch = {}), (h.watching = !1);
          }
        },
        m = (e, t, r) => {
          let n = new Map(),
        ...
        v = {
          hasItem(e, t = {}) {
            let { relativeKey: r, driver: n } = d((e = a(e)));
            return i(n.hasItem, r, t);
          },
          getItem(e, t = {}) {
            let { relativeKey: n, driver: o } = d((e = a(e)));
            return i(o.getItem, n, t).then((e) => (0, r.default)(e));
          },
          getItems: (e, t = {}) =>
            m(e, t, (e) =>
              e.driver.getItems
                ? i(
                    ...
                    t.map((t) => ({
                      ...
                      value: (0, r.default)(t.value),
                    }))
                  )
                : Promise.all(
                    e.items.map((t) =>
                      i(e.driver.getItem, t.relativeKey, t.options).then(
                        (e) => ({ key: t.key, value: (0, r.default)(e) })
                      )
                    )
                  )
            ),
          getItemRaw(e, t = {}) {
            let { relativeKey: r, driver: o } = d((e = a(e)));
            return o.getItemRaw
              ? i(o.getItemRaw, r, t)
              : i(o.getItem, r, t).then((e) => {
                  var t;
                  return "string" == typeof e && e.startsWith(s)
                    ? ((t = e.slice(s.length)),
                      globalThis.Buffer
          ...
          async setItem(e, t, r = {}) {
            ...
            let { relativeKey: n, driver: s } = d((e = a(e)));
            s.setItem &&
              (await i(s.setItem, n, o(t), r), s.watch || b("update", e));
          },
          async setItems(e, t) {
            await m(e, t, async (e) => {
              ...
              e.driver.setItem &&
                (await Promise.all(
                  e.items.map((t) =>
                    i(e.driver.setItem, t.relativeKey, o(t.value), t.options)
                  )
                ));
            });
          },
          async setItemRaw(e, t, r = {}) {
            if (void 0 === t) return v.removeItem(e, r);
            let { relativeKey: o, driver: u } = d((e = a(e)));
            if (u.setItemRaw) await i(u.setItemRaw, o, t, r);
            else {
              var l;
              if (!u.setItem) return;
              await i(
                ...
                "string" == typeof t
                  ...
                  : s +
                      ((l = t),
                      globalThis.Buffer
                        ? n.Buffer.from(l).toString("base64")
          ...
          async getMeta(e, t = {}) {
            ...
            if (
              (o.getMeta && Object.assign(s, await i(o.getMeta, n, t)),
              !t.nativeOnly)
            ) {
              let e = await i(o.getItem, n + "$", t).then((e) =>
                (0, r.default)(e)
              );
              e &&
                "object" == typeof e &&
          ...
          async getKeys(e, t = {}) {
            ...
            for (let e of r) {
              ...
              await i(e.driver.getKeys, e.relativeBase, t))) {
                let t = e.mountpoint + a(r);
                n.some((e) => t.startsWith(e)) || o.push(t);
              }
              n = [
                e.mountpoint,
          ...
          async clear(e, t = {}) {
            (e = u(e)),
              await Promise.all(
                p(e, !1).map(async (e) =>
                  e.driver.clear
                    ? i(e.driver.clear, e.relativeBase, t)
                    : e.driver.removeItem
                    ? Promise.all(
                        (
          ...
          async dispose() {
            await Promise.all(Object.values(h.mounts).map((e) => f(e)));
          },
          watch: async (e) => (
            await y(),
            h.watchListeners.push(e),
            async () => {
              (h.watchListeners = h.watchListeners.filter((t) => t !== e)),
                0 === h.watchListeners.length && (await g());
            }
          ),
          async unwatch() {
            (h.watchListeners = []), await g();
          },
          mount(e, t) {
            if ((e = u(e)) && h.mounts[e])
            ...
            return (
              e &&
                (h.mountpoints.push(e),
                h.mountpoints.sort((e, t) => t.length - e.length)),
              (h.mounts[e] = t),
              h.watching &&
                Promise.resolve(c(t, b, e))
                  .then((t) => {
                    h.unwatch[e] = t;
                  })
                  .catch(console.error),
          ...
          async unmount(e, t = !0) {
            (e = u(e)) &&
              ...
              (h.watching &&
                e in h.unwatch &&
                (h.unwatch[e]?.(), delete h.unwatch[e]),
              t && (await f(h.mounts[e])),
              (h.mountpoints = h.mountpoints.filter((t) => t !== e)),
              delete h.mounts[e]);
          },
          getMount(e = "") {
            let t = d((e = a(e) + ":"));
    ...
    async function f(e) {
      "function" == typeof e.dispose && (await i(e.dispose));
    }
    function h(e) {
    ...
    function b(e, t = p()) {
      return t("readonly", (t) => h(t.get(e)));
    }
    function y(e, t, r = p()) {
      return r("readwrite", (r) => (r.put(t, e), h(r.transaction)));
    }
    function g(e, t = p()) {
      return t("readwrite", (t) => (t.delete(e), h(t.transaction)));
    }
    function m(e = p()) {
      return e("readwrite", (e) => (e.clear(), h(e.transaction)));
    }
    function v(e = p()) {
      return e("readonly", (e) => {
        var t;
        if (e.getAllKeys) return h(e.getAllKeys());
        let r = [];
        return ((t = (e) => r.push(e.key)),
        (e.openCursor().onsuccess = function () {
          this.result && (t(this.result), this.result.continue());
        }),
        h(e.transaction)).then(() => r);
      });
    }
    e.s(["createStorage", () => l], 65123),
      e.s(
        [
          "clear",
          () => m,
  ...
  (e, t, r) => {
    ...
    t.exports = function (e, t, r) {
      ...
      if (0 === u) return e;
      for (
        var l = "", c = 0, f = -1, h = (e && e.length) || 0, d = 0;
        d < h;
  ...
  (e, t, r) => {
    ...
    function s(e, t, r, s) {
      ...
      (t[r] =
        t.levelVal > t.levels.values[r] ? h : u[r] ? u[r] : i[r] || i[s] || h),
        (function (e, t, r) {
          if (e.transmit || t[r] !== h) {
            var s;
            t[r] =
                ...
                let u = e.timestamp(),
                  ...
                  f =
                    Object.getPrototypeOf && Object.getPrototypeOf(this) === i
                      ? i
                      : this;
                for (var h, d, p, b = 0; b < c.length; b++) c[b] = arguments[b];
                if (
                  (e.serialize &&
                    !e.asObject &&
                    a(
                  ...
                  (h = this),
                    ...
                    (f = d.methodValue),
                    (b = d.val),
                    (y = h._logEvent.bindings),
                    a(
                      p,
                      h._serialize || Object.keys(h.serializers),
                      h.serializers,
                      void 0 === h._stdErrSerialize || h._stdErrSerialize
                    ),
                    (h._logEvent.ts = i),
                    (h._logEvent.messages = p.filter(function (e) {
                      return -1 === y.indexOf(e);
                    })),
                    (h._logEvent.level.label = s),
                    (h._logEvent.level.value = f),
                    n(s, h._logEvent, b),
                    (h._logEvent = l(y));
                }
              });
  ...
  (e) => {
    ...
    class i {
      constructor() {
        this.indexedDb = (0, t.createStorage)({
          driver: ((e = {}) => {
            let t,
              n = e.base && e.base.length > 0 ? `${e.base}:` : "";
            return (
              e.dbName &&
                e.storeName &&
                (t = (0, r.createStore)(e.dbName, e.storeName)),
              {
                name: "idb-keyval",
                options: e,
                hasItem: async (e) =>
                  !(typeof (await (0, r.get)(n + e, t)) > "u"),
                getItem: async (e) => (await (0, r.get)(n + e, t)) ?? null,
                setItem: (e, i) => (0, r.set)(n + e, i, t),
                removeItem: (e) => (0, r.del)(n + e, t),
                getKeys: () => (0, r.keys)(t),
                clear: () => (0, r.clear)(t),
              }
            );
      ...
      async setItem(e, t) {
        await this.indexedDb.setItem(e, (0, n.safeJsonStringify)(t));
      }
      async removeItem(e) {
    ...
    function a(e) {
      var t;
      return [e[0], (0, n.safeJsonParse)(null != (t = e[1]) ? t : "")];
    }
    function u() {}
    ...
    class l {
      ...
      async getItem(e) {
        ...
        if (null !== t) return (0, n.safeJsonParse)(t);
      }
      async setItem(e, t) {
        this.localStorage.setItem(e, (0, n.safeJsonStringify)(t));
      }
      async removeItem(e) {
    ...
    e.s(["default", () => h], 499276);
    var d = e.i(102232);
    let p = "custom_context";
    class b {
      constructor(e) {
        (this.nodeValue = e),
    ...
    class g {
      constructor(e, t = 1024e3) {
        (this.level = e ?? "error"),
          (this.levelValue = d.levels.values[this.level]),
          (this.MAX_LOG_SIZE_IN_BYTES = t),
          (this.logs = new y(this.MAX_LOG_SIZE_IN_BYTES));
      }
      forwardToConsole(e, t) {
        t === d.levels.values.error
          ? console.error(e)
          : t === d.levels.values.warn
          ? console.warn(e)
          : t === d.levels.values.debug
          ? console.debug(e)
          : t === d.levels.values.trace
          ? console.trace(e)
          : console.log(e);
      }
      appendToLogs(e) {
        this.logs.append(
          (0, n.safeJsonStringify)({
      ...
      logsToBlob(e) {
        ...
        return (
          t.push((0, n.safeJsonStringify)({ extraMetadata: e })),
    ...
    class m {
      constructor(e, t = 1024e3) {
        this.baseChunkLogger = new g(e, t);
      }
      write(e) {
    ...
    var D = Object.defineProperty,
      ...
      S = (e, t, r) =>
        t in e
          ...
          : (e[t] = r),
      A = (e, t) => {
        for (var r in t || (t = {})) _.call(t, r) && S(e, r, t[r]);
        if (x) for (var r of x(t)) O.call(t, r) && S(e, r, t[r]);
        return e;
      };
    function C(e) {
      return w(A({}, e), E({ level: e?.level || "info" }));
    }
    function I(e, t = p) {
    ...
    function B(e, t, r = p) {
      let n = (function (e, t, r = p) {
        let n = I(e, r);
        return n.trim() ? `${n}/${t}` : t;
      })(e, t, r);
      return (function (e, t, r = p) {
        return (e[r] = t), e;
    ...
    function T(e) {
      ...
      return "u" > typeof e.loggerOverride &&
        ...
        : "u" > typeof window
        ? ((u = new m(
            null == (n = (r = e).opts) ? void 0 : n.level,
            r.maxSizeInBytes
          )),
          {
            logger: (0, d.default)(
              ...
              (a = {
                level: "trace",
                browser: w(
                  A({}, null == (i = r.opts) ? void 0 : i.browser),
                  E({ write: (e) => u.write(e) })
                ),
              }),
              w(s, E(a)))
            ),
            chunkLoggerController: u,
          })
        : ((o = new v(
          ...
          {
            logger: (0, d.default)(w(A({}, e.opts), E({ level: "trace" })), o),
  ...
  (e, t, r) => {
    ...
    function n() {
      return (
        (null === e.g || void 0 === e.g ? void 0 : e.g.crypto) ||
        (null === e.g || void 0 === e.g ? void 0 : e.g.msCrypto) ||
        {}
      );
    }
    function i() {
  ...
  (e, t, r) => {
    ...
    Object.defineProperty(r, "__esModule", { value: !0 });
    let n = e.r(952439);
    n.__exportStar(e.r(493599), r), n.__exportStar(e.r(431443), r);
  },
  512442,
  (e, t, r) => {
    "use strict";
  ...
  (e, t, r) => {
    ...
    (function (t) {
      ...
      function b() {
        return (
          ...
          (this.arrayBuffer = function () {
            ...
            if (n.blob) return this.blob().then(d);
      ...
      (v.redirect = function (e, t) {
        if (-1 === D.indexOf(t)) throw RangeError("Invalid status code");
        ...
        return new Promise(function (o, s) {
          ...
          if (
            ...
            "responseType" in f &&
              (n.blob
                ? (f.responseType = "blob")
                : n.arrayBuffer && (f.responseType = "arraybuffer")),
            i &&
            ...
            Object.getOwnPropertyNames(i.headers).forEach(function (e) {
              d.push(a(e)), f.setRequestHeader(e, u(i.headers[e]));
            }),
      ...
      (w.polyfill = !0),
        r.fetch ||
          ((r.fetch = w), (r.Headers = c), (r.Request = g), (r.Response = v)),
        (t.Headers = c),
        (t.Request = g),
        (t.Response = v),
        (t.fetch = w),
  ...
  (e) => {
    ...
    function f(e, t, r) {
      return { id: r || l(), jsonrpc: "2.0", method: e, params: t };
    }
    function h(e, t) {
      ...
      return {
        ...
        error:
          ...
          void 0 === u
            ? s(r)
            : ("string" == typeof u &&
                (u = Object.assign(Object.assign({}, s(n)), { message: u })),
              void 0 !== l && (u.data = l),
              (c = u.code),
              i.includes(c) &&
                ((f = u.code),
                (u = (h = Object.values(o).find((e) => e.code === f)) || o[n])),
              u)),
      };
    }
    u.isNode,
    ...
    class O extends y {
      ...
      async request(e, t) {
        return this.requestStrict(
          f(e.method, e.params || [], e.id || c().toString()),
          t
        );
      }
    ...
    e.s(["JsonRpcProvider", () => O], 501365);
    var S = e.i(31794);
    let A = (e) => e.split("?")[0],
      C =
        "u" > typeof WebSocket
          ? WebSocket
          : "u" > typeof e.g.WebSocket
          ? e.g.WebSocket
    ...
    var B = e.i(320502),
      ...
      R = (e, t, r) =>
        t in e
          ...
          : (e[t] = r),
      k = (e, t) => {
        for (var r in t || (t = {})) U.call(t, r) && R(e, r, t[r]);
        if (N) for (var r of N(t)) j.call(t, r) && R(e, r, t[r]);
        return e;
      };
    let M = {
      headers: {
    ...
    class F {
      ...
      async send(e) {
        ...
        try {
          let t,
            r,
            n = (0, S.safeJsonStringify)(e),
            i = await (
              await (0, B.default)(
                this.url,
                ((t = k({}, M)), (r = { body: n }), P(t, L(r)))
              )
            ).json();
    ...
    e.s(["HttpConnection", () => F, "default", () => F], 98418);
  },
]);
